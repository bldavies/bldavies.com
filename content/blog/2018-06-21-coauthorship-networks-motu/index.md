...
The R script [`data.R`](https://github.com/bldavies/motu-wp/blob/master/code/data.R) scrapes the directory for a list of working paper IDs and URLs.
...
The resulting file [`authors.csv`](https://github.com/bldavies/motu-wp/blob/master/data/authors.csv) contains each unique author-paper pair.
...
data_url <- 'https://raw.githubusercontent.com/bldavies/motu-wp/master/data/'
...
[`areas.csv`](https://github.com/bldavies/motu-wp/blob/master/data/areas.csv) contains the name, ID and ambient colour for each of [Motu's six primary research areas](https://motu.nz/our-work/), and is created manually.
[`papers.csv`](https://github.com/bldavies/motu-wp/blob/master/data/papers.csv) links each paper to its research area.
I merge `areas`, `authors` and `papers` into a single tibble `data`:
...
[repo]: https://github.com/bldavies/motu-wp
