...
\paper{\href{https://bldavies.com/jmp.pdf}{\bfseries The value of conceptual knowledge} (job market paper, with Anirudh Sankar)}{We define and quantify the instrumental value of conceptual knowledge.
...
\paper{\href{https://doi.org/10.1016/j.econlet.2026.113060}{\bfseries Persistence, patience and costly information acquisition} \\ \emph{Economics Letters}, 2026}{A forward-looking agent observes signals of a state that follows a Gaussian AR(1) process.
He balances the cost of having imprecise beliefs with the cost of acquiring more precise signals.
I characterize his optimal information acquisition policy, and analyze how his steady-state beliefs and costs depend on persistence (the AR(1) parameter) and patience (the agent's discount factor).
Higher persistence has a non-monotone effect on belief precision and raises overall costs.
Higher patience makes beliefs more precise and lowers overall costs.
}
\vskip1em
...
\subsection{Stanford University}
\datedentry{2026--}{Teaching Assistant for ECON 198 (Junior Honors Seminar)}
